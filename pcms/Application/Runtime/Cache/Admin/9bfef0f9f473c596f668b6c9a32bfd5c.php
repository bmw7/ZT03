...
<div class="custom_main">
	<div class="custom_title">
		...
		<div class="widget-menu pull-right mr10"><a href="<?php echo U('admin/category/add');?>"><i class="fa fa-plus-square"></i> &nbsp;添加分类</a></div>
	</div>
            ...
            <tbody>                            
				<?php if(is_array($tree)): $i = 0; $__LIST__ = $tree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$category): $mod = ($i % 2 );++$i;?><tr>
					...
					<td>
					    ...
					    <?php elseif($category["type"] == 2): ?><span class="glyphicons glyphicons-more_windows">&nbsp;多篇</span><?php endif; ?>
					</td>
					
					<td>
					<a href="#" class="moveup" id="<?php echo ($category["id"]); ?>" orders="<?php echo ($category["orders"]); ?>" grade="<?php echo ($category["grade"]); ?>"><span class="glyphicons glyphicons-up_arrow"></span>上</a>&nbsp;&nbsp;<a href="#" class="movedown" id="<?php echo ($category["id"]); ?>" orders="<?php echo ($category["orders"]); ?>" grade="<?php echo ($category["grade"]); ?>"><span class="glyphicons glyphicons-down_arrow"></span>下</a>
					</td>
