       ...
       <aside id="sidebar_left" class="nano  sidebar-light light">
            <div class="nano-content">
                ...
                <ul class="nav sidebar-menu">
                    ...
                    <li>
                        <a href="<?php echo U('admin/article/add');?>" target="iframe">
                    ...
                    <li>
                        <a href="<?php echo U('admin/navigation/index');?>" target="iframe">
        ...
        <section id="content_wrapper">   
         	<section id="content">
                 <iframe id="iframe" name="iframe" src="<?php echo U('admin/login/welcome');?>" frameborder="0" width="100%" height="auto" scrolling="no" onLoad="iFrameHeight()"></iframe>
            </section>
        </section>
